...
type Props = {
  /** Called when a trace row is clicked. Parent should navigate to /traces/:traceId. */
...
export function TracesPage({ onTraceClick, apiBase = "/api/v1" }: Props) {
  ...
  }, [apiBase, filters.from, filters.to]);
